...
\begin{figure}[H]
        ...
        \begin{scope}[xshift=1.5cm]
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.75\textwidth]{Images/ExplodedView.png}};
                \begin{scope}[x={(image.south east)},y={(image.north west)}]
            
                    \node [anchor=west] (L0_L) at (0.25,1.1) {Link 0};
                    \node [anchor=west] (L1) at (0.25,1.1) {Link 1}
                    \node [anchor=west] (L2) at (0.25,1.1) {Link 2};
                    \node [anchor=west] (L0_T) at (0.25,1.1) {Link 0};
                    \node [anchor=west] (L1_T) at (0.25,1.1) {Link 1};
                    \node [anchor=west] (L0_H) at (0.25,1.1) {Link 0};
                    \node [anchor=west] (L1_H) at (0.25,1.1) {Link 1};
                    \node [anchor=west] (Leg) at (0.25,1.1) {Leg};
                    \node [anchor=west] (Tail) at (0.25,1.1) {Tail};
                    \node [anchor=west] (Head) at (0.25,1.1) {Head};
         
                    \draw[red,thick] (0.59,0.59) circle (0.35cm);    
                    \draw[red,thick] (0.6,0.5) circle (0.35cm);
                    \draw[red,thick] (0.68,0.43) circle (0.35cm);
                    \draw[red,thick] (0.62,0.7) circle (0.2cm);
                    \draw[red,thick] (0.65,0.75) circle (0.3cm);
                    \draw[red,thick] (0.36,0.445) circle (0.2cm);
                    \draw[red,thick] (0.315,0.46) circle (0.25cm);
                    
                    \draw [-latex,thick, red] (PSU) to[out=0, in=90] (0.485,0.97);
...
\section{Electronics Results}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \begin{scope}[xshift=1.5cm]
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.75\textwidth]{Images/Motherboard.png}};
                \begin{scope}[x={(image.south east)},y={(image.north west)}]
                
                    \node [anchor=west] (PSU) at (0.25,1.1) {\thead{6V 20A\\PSU}};
                    \node [anchor=west] (FUSES) at (-0.1,1.1) {Limb Fuses};
                    \node [anchor=west] (CS) at (1.01,0.2) {\thead{Current\\Sensors}};
                    \node [anchor=west] (MOTORCONN) at (-0.16,0.3) {\thead{Servo\\Connectors}};
                    \node [anchor=west] (ESP32) at (0.15,-0.1) {ESP32};
                    \node [anchor=west] (SM) at (0.75,-0.1) {Safety MCU};
                    \node [anchor=west] (IMU) at (0.4,-0.1) {IMU};
                    \node [anchor=west] (BC) at (1.05,0.8) {\thead{Battery \\Charger}};
                    \node [anchor=west] (USBCPD) at (0.8,1.2) {\thead{USB-C PD\\Power\& Programming}};
                
                    \draw[red,thick,rounded corners] (0.3,0.71) rectangle (0.61,0.97);
                    \draw[red,thick,rounded corners] (0.62,0.55) rectangle (0.95,0.95);
                    \draw[red,thick] (0.01,0.15) rectangle (0.125,0.825);    
                    
                    \draw [-latex,thick, red] (PSU) to[out=0, in=90] (0.485,0.97);
                    \draw [-latex,thick, red] (USBCPD) to[out=180, in=90] (0.75,0.99);
                    \draw [-latex,thick, red] (BC) to[out=180, in=0] (0.95,0.75);
                    \draw [-latex,thick, red] (ESP32) to[out=90, in=-90] (0.35,0.27);
                    \draw [-latex,thick, red] (IMU) to[out=90, in=-90] (0.5,0.45);
                    \draw [-latex,thick, red] (SM) to[out=180, in=0] (0.6,0.4);
                    \draw [-latex,thick, red] (MOTORCONN) to[out=90, in=180] (0.01,0.55);
                    \draw [-latex,thick, red] (FUSES) to[out=0, in=90] (0.15,0.95);
                    \draw [-latex,thick, red] (CS) to[out=180, in=0] (0.8175,0.21);
...
%More needs to be added here to reference the figure below this
